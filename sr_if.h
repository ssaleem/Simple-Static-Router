...
int packet_for_me(struct sr_instance*, uint32_t dst_ip); /*Added by Sara: Called in sr_router.c*/
struct sr_if* sr_get_interface_fromMAC(struct sr_instance*, const char*); /*Added by Sara: Called in sr_router.c*/
